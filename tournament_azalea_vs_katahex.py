#!/usr/bin/env python3
"""
Tournament: AzaleaAgent vs KataHexAgent (20 games)

Run locally or on CSF3:
    python3 tournament_azalea_vs_katahex.py
"""
...
def main():
    print("=" * 70)
    print("TOURNAMENT: AzaleaAgent vs KataHexAgent")
    ...
    for i in range(NUM_GAMES):
        ...
        try:
            ...
            elif result["winner"] == "KataHex":
                katahex_wins += 1
                print(f"KataHex wins! ({result['p1']} as P1)")
            else:
    ...
    print(f"KataHex wins:      {katahex_wins}/{NUM_GAMES} ({100*katahex_wins/NUM_GAMES:.1f}%)")
    print(f"Other:             {NUM_GAMES - azalea_wins - katahex_wins}/{NUM_GAMES}")
