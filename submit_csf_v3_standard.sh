#!/bin/bash --login
#SBATCH --job-name=hex_v3_std
#SBATCH -p gpuA
#SBATCH -G 1
#SBATCH -n 12
#SBATCH --mem=64G
#SBATCH -t 1-0
#SBATCH --output=logs/hex_v3_std_%j.out
#SBATCH --error=logs/hex_v3_std_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=r36859ak@student.manchester.ac.uk

# ============================================================================
# Group12 Hex AI V3 STANDARD - Parallel Training (8-12 hours)
# ============================================================================
#
# Configuration:
#   - 25 iterations
#   - 300 games per iteration
#   - 150 MCTS simulations (faster than V2's 400)
#   - 10 parallel workers
...
echo "=============================================="
echo "GROUP12 HEX AI V3 - STANDARD MODE"
echo "=============================================="
...
OUTPUT_DIR="$PROJECT_DIR/output_v3_standard_${SLURM_JOB_ID}"
mkdir -p "$OUTPUT_DIR"
...
echo ""
echo "=============================================="
echo "V3 STANDARD Configuration"
echo "=============================================="
echo "Iterations: 25"
echo "Games/iter: 300"
echo "MCTS sims: 150"
echo "Workers: 10"
echo "Expected: 8-12 hours"
echo "=============================================="
...
if [ -f "$OUTPUT_DIR/models/hex_model_v3_best.pth" ]; then
    cp "$OUTPUT_DIR/models/hex_model_v3_best.pth" "$PROJECT_DIR/models/hex_model_v3_standard.pth"
fi

if [ -f "$OUTPUT_DIR/models/hex_model_v3_numpy.npz" ]; then
    cp "$OUTPUT_DIR/models/hex_model_v3_numpy.npz" "$PROJECT_DIR/agents/Group12/models/hex_model_v3_standard.npz"
fi

echo ""
echo "=============================================="
echo "V3 STANDARD Complete!"
echo "=============================================="
echo "End: $(date)"
